    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu" style="margin-top: 0">
                ...
                <li class="sidebar-item has-sub @if(($active == 'paskas proses') || ($active == 'paskas lolos') || ($active == 'paskas tidak lolos') || ($active == 'paskas hapus')) active @endif">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-inboxes-fill"></i>
                        <span>Paskas</span>
                    </a>
                    <ul class="submenu" @if(($active == 'paskas proses') || ($active == 'paskas lolos') || ($active == 'paskas tidak lolos') || ($active == 'paskas hapus')) style="display: block" @endif>
                ...
                <li class="sidebar-item has-sub @if(($active == 'sebar proses') || ($active == 'sebar lolos') || ($active == 'sebar tidak lolos') || ($active == 'sebar hapus')) active @endif">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-inboxes-fill"></i>
                        <span>Sebar</span>
                    </a>
                    <ul class="submenu" @if(($active == 'sebar proses') || ($active == 'sebar lolos') || ($active == 'sebar tidak lolos') || ($active == 'sebar hapus')) style="display: block" @endif>
