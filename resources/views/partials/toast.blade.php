@if (session()->has('warning'))
    <div class="toastify on  toastify-center toastify-top alert" duration='5000' role="alert"
        style="background: rgb(255, 193, 7); transform: translate(0px, 0px); top: 75px;">
        {{ session('warning') }}
        <span class="toast-close" data-bs-dismiss="alert" aria-label="Close">✖</span>
    </div>
@elseif (session()->has('success'))
    <div class="toastify on  toastify-center toastify-top alert" duration='2500' role="alert"
        style="background:rgb(25, 135, 84); transform: translate(0px, 0px); top: 75px;">
        {{ session('success') }}
        <span class="toast-close" data-bs-dismiss="alert" aria-label="Close">✖</span>
    </div>
@elseif (session()->has('danger'))
    <div class="toastify on  toastify-center toastify-top alert" duration='5000' role="alert"
        style="background: rgb(220, 53, 69); transform: translate(0px, 0px); top: 75px;">
        {{ session('danger') }}
        <span class="toast-close" data-bs-dismiss="alert" aria-label="Close">✖</span>
    </div>
@endif
